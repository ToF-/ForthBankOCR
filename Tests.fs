...
: CHECKS
    ...
    ASSERT( [ 2 BASE ! ] 000111001 [ DECIMAL ] DIGIT [CHAR] 4 =  )
    ASSERT( 0 OCR>PATTERN DIGIT [CHAR] 0 = ) 
    ASSERT( 1 OCR>PATTERN DIGIT [CHAR] 1 = ) 
    ASSERT( 2 OCR>PATTERN DIGIT [CHAR] 2 = ) 
    ASSERT( 3 OCR>PATTERN DIGIT [CHAR] 3 = ) 
    ASSERT( 4 OCR>PATTERN DIGIT [CHAR] 4 = ) 
    ASSERT( 5 OCR>PATTERN DIGIT [CHAR] 5 = ) 
    ASSERT( 6 OCR>PATTERN DIGIT [CHAR] 6 = ) 
    ASSERT( 7 OCR>PATTERN DIGIT [CHAR] 7 = ) 
    ASSERT( 8 OCR>PATTERN DIGIT [CHAR] 8 = ) 
    \ altering an ocr digit
    OCR-BITS 1+ 32 SWAP C!
    ASSERT( 0 OCR>PATTERN DIGIT NOT-FOUND = ) 
