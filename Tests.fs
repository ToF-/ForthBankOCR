...
: CHECKS
    ...
    ASSERT( 0 PATTERN DIGIT [CHAR] 0 = ) 
    ASSERT( 1 PATTERN DIGIT [CHAR] 1 = ) 
    ASSERT( 2 PATTERN DIGIT [CHAR] 2 = ) 
    ASSERT( 3 PATTERN DIGIT [CHAR] 3 = ) 
    ASSERT( 4 PATTERN DIGIT [CHAR] 4 = ) 
    ASSERT( 5 PATTERN DIGIT [CHAR] 5 = ) 
    ASSERT( 6 PATTERN DIGIT [CHAR] 6 = ) 
    ASSERT( 7 PATTERN DIGIT [CHAR] 7 = ) 
    ASSERT( 8 PATTERN DIGIT [CHAR] 8 = ) 
    \ altering an ocr digit
    OCR-BITS 1+ 32 SWAP C!
    ASSERT( 0 PATTERN DIGIT NOT-FOUND = ) 
