...
CREATE ALT-ACCOUNTS 81 9 * ALLOT
...
: FIND-MISSING-IN-OCR ( addr -- ) 
    8 0 DO 
        DUPLICATE-OCR-BITS
        DUP I CHANGE-MISSING-BIT
        ALT-OCR-BITS 9 OCR-BITS 9 COMPARE IF
...
: FIND-MISSING-BAR ( -- )
    ALT-ACCOUNTS-MAX OFF 
    9 0 DO ALT-OCR-BITS I + FIND-MISSING-IN-OCR LOOP ;
